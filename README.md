...
2. Constrained Euler (`main_CE.py`). See [She & Jackson Phys. Rev. Lett. 70, 1255 (1993)](https://doi.org/10.1103/PhysRevLett.70.1255) for info on Constrained Euloer, and [Zhou Phys. Fluids 5, 2511–2524 (1993)](https://doi.org/10.1063/1.858764) for info on how it is implemented here.
