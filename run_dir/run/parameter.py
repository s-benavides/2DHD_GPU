...
step =  1e7           # Numer of steps in run   
...
kdn = 8.0                  # lowest forced wavenumber
kup = 10.0                 # highest forcing wavenumber
nu = 2e-6                  # viscosity, 0.001 for n=256 and nn=1
hnu = 0.50                 # hypoviscosity, 0.5 
