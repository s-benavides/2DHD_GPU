...
thtsstep = 100000000  # Number of steps between theta time series output
...
### Fluid parameters ###
########################
fp0 = Tf(10.60)                # streamfunction forcing amplitude
u0 = Tf(0.10)                  # streamfunction ic amplitude
kdn = Tf(23.5)                # lowest forced wavenumber
kup = Tf(24.5)                # highest forcing wavenumber
nu = Tf(0.0015)              # viscosity, 0.001 for n=256 and nn=1
hnu = Tf(0.1)              # hypoviscosity, 0.5 
nn = Ti(1)                     # order of dissipation 
mm = Ti(0)                     # order of hypo-dissipation
